...
class ScrollBar:
    ...
    curso1ESMAD = Button(text = "Licenciatura em Tecnologias e Sistemas de Informação Para a Web", relief = "flat",font= (20), command = paginaCurso1ESMAD)
...
''',width = 1500)
    msgCurso1ESMAD.place(x=20,y=530) 

...
class ScrollBar:
    def paginaCurso1():
        ...
        textoCurso1 = Text(curso1, width = 1980,height = 1600,wrap = NONE,relief = FLAT, font = "200",yscrollcommand = v.set,)
        textoCurso1.insert(END,'''\n\n\n\n\n
        ...
        textoCurso1.config(state = DISABLED)
    ...
    def paginaCurso2():
        ...
        v = Scrollbar(curso2)
        v.pack(side = RIGHT,fill = Y)
        texoCurso2 = Text(curso2, width = 1980, height = 1600,wrap = NONE,relief = FLAT,font = "200",yscrollcommand = v.set)
        texoCurso2.insert(END,'''\n\n\n\n\n
...
''',width = 1500)
    ...
    curso2 = Button(text = "Licenciatura em Gestão", relief = "flat",font = (20), command = paginaCurso2)

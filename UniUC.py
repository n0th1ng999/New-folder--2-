...
class ScrollBar:
    def paginaCurso1UC():
        ...
        frameCursoUC = Frame(curso1UC,width = 400,height = 100,relief = "sunken")
        frameCursoUC.pack(side = TOP)
        espaço = Label(curso1UC,text = "")
        espaço.pack()
        espaço = Label(curso1UC,text = "")
        espaço.pack()
        comentarioLabel = Label(curso1UC,text = "Comentarios",font = "200")
        comentarioLabel.pack()
        espaço = Label(curso1UC,text = "")
        espaço.pack()
        frameComentariosUC = Frame(curso1UC,width=400,height=5,relief = "sunken")
        frameComentariosUC.pack(side = BOTTOM)
        v = Scrollbar(frameCursoUC)
        v.pack(side = RIGHT,fill = Y)
        comentarios = Text(frameComentariosUC,width = 100, height = 20,wrap = NONE)
        comentarios.insert(END,"dfugdsgdsugfi")
        comentarios.pack()
        textoCurso1UC = Text(frameCursoUC,width = 200,height = 35,wrap = NONE,relief = FLAT,font = "200",yscrollcommand = v.set)
    ...
    def paginaCurso2UC():
        ...
        frameCurso2UC = Frame(curso2UC,width = 400,height = 100,relief = "sunken")
        frameCurso2UC.pack(side = TOP)
        espaço = Label(curso2UC,text = "")
        espaço.pack()
        espaço = Label(curso2UC,text = "")
        espaço.pack()
        comentarioLabel = Label(curso2UC,text = "Comentarios",font = "200")
        comentarioLabel.pack()
        espaço = Label(curso2UC,text = "")
        espaço.pack()
        frameComentarios2UC = Frame(curso2UC,width=400,height=5,relief = "sunken")
        frameComentarios2UC.pack(side = BOTTOM)
        v = Scrollbar(frameCurso2UC)
        v.pack(side = RIGHT,fill = Y)
        comentarios = Text(frameComentarios2UC,width = 100, height = 20,wrap = NONE)
        comentarios.insert(END,"dfugdsgdsugfi")
        comentarios.pack()
        textoCurso2UC = Text(frameCurso2UC,width = 200,height = 35,wrap = NONE,relief = FLAT,font = "200",yscrollcommand = v.set)
